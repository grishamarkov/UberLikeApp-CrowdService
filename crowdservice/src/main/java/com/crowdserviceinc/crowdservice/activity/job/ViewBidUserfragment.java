...
import com.crowdserviceinc.crowdservice.adapter.ViewBidUserAdapter;
...
import com.crowdserviceinc.crowdservice.parser.CourierListParser;
...
//				acceptBidEvent.put("BidUserId",bd.getId());
			...
			if (!dataList.equals("")) {// really  comeback
